...
if (isset($_POST['login']))
 {
   ...
   if ($error['leng']=="") 
   {
      $username = mysqli_real_escape_string($con, $_POST['username']);//performs sql injections
      $password = mysqli_real_escape_string($con, $_POST['password']);//performs sql injections
