  ...
  .drop .drops{
   ...
   <div id="sidebar" class="nav-collapse">
      ...
      <ul id="nav-accordion" class="sidebar-menu">
         ...
         <li class="dropdown">
           <a href="#"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-dashboard"></i><span>Analysis</span></a>
              <ul class="dropdown-menu">
               
                        <li class="drop"><a class="drops" href="studentsearch.php">College Analysis</a></li>
                        <li class="drop"><a class="drops" href="collegesearch.php">Branch analysis</a></li>
